...
import { Mail, Lock, Eye, EyeOff, Loader, AlertCircle, User } from 'lucide-react';
...
export const SignupPage = () => {
  ...
  const { signup, getGoogleAuthUrl, error, clearError } = useAuth();
  ...
  const handleGoogleSignup = async () => {
    ...
    if (url) {
      ...
      setLocalError('Failed to initialize Google signup');
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Start managing your finances with ClearFlow
        </p>
      </div>
